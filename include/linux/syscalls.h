...
//asmlinkage long sys_do_chronos_mutex(struct mutex_data __user *mutexreq);	//Modified version of sys_do_chronos_mutex is shown below to specify which protocol is used
/********* SH-ST ***********/
asmlinkage long sys_do_chronos_mutex(struct mutex_data __user **mutexreq, int op, int __user *num_mutex, int __user *lock_pro, int __user *num_proc, int __user *sched_no);
/********* SH-END ***********/
